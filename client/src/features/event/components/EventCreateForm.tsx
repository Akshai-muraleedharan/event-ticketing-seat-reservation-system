        ...
        <form className='w-[80%] mx-auto' onSubmit={handleSubmit(onSubmit)}>
            ...
            <fieldset className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-5'>
                <div>
                    ...
                    <input type="text" {...register("capacity")} placeholder="Eg: 200 " className="input w-full input-primary" />
                </div>
            ...
            {isTicket && <fieldset className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-5'>
                <div>
                    ...
                    <input type="datetime-local" {...register("ticketBookStartTime")} className="input w-full input-primary" />
                </div>


                <div>
                    <legend className="fieldset-legend">Ticket Booking Ending Date</legend>
                    <input type="datetime-local" {...register("ticketBookEndTime")} className="input w-full input-primary" />
                </div>
            </fieldset>}
